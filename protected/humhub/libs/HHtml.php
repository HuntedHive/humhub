...
class HHtml extends Html
{
    ...
    public static function ajaxLink($text, $url, $ajaxOptions = array(), $htmlOptions = array())
    {
        ...
        // Auto set csrf token
        if (isset($ajaxOptions['data']) && is_array($ajaxOptions['data']) && !isset($ajaxOptions['data'][Yii::$app->request->csrfToken])) {
            $ajaxOptions['data'][Yii::$app->request->csrfToken] = Yii::$app->request->csrfToken;
        }

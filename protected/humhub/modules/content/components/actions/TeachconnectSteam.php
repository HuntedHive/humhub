 ...
 * @since 0.11
 */
class TeachconnectSteam extends \yii\base\Action
{
    ...
    private static $maxCountObject = [
        ChatMessage::class => self::CHAT_COUNT,
        Question::class => self::QA_COUNT,
        Answer::class => self::QA_COUNT,
        QAComment::class => self::QA_COUNT,
        Created::class => self::CONTENT_COUNT,
        ContentCreated::class => self::CONTENT_COUNT,
        NewComment::class => self::CONTENT_COUNT,
    ];

    private static $countObject = [
        ChatMessage::class => self::ZERO,
        Question::class => self::ZERO,
        Answer::class => self::ZERO,
        QAComment::class => self::ZERO,
        Created::class => self::ZERO,
        ContentCreated::class => self::ZERO,
        NewComment::class => self::ZERO,
    ];

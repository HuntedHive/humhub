                                            ...
                                            <table border="0" cellspacing="0" cellpadding="0" align="center">
                                                ...
                                                <tr>
                                                    <td style="font-size: 14px; line-height: 22px; font-family:Open Sans,Arial,Tahoma, Helvetica, sans-serif; color:#777777; font-weight:300; text-align:center; ">
                                                        ...
                                                        <?php echo Yii::t('UserModule.views_mails_UserInviteSelf', 'Welcome to %appName%,  the altruistic community of Australian teachers and teaching knowledge. It’s free, always will be, and exists to help YOU, the teacher.', array('%appName%' => Html::encode(Yii::$app->name))); ?>
                                                ...
                                                <tr>
                                                    <td style="font-size: 14px; line-height: 22px; font-family:Open Sans,Arial,Tahoma, Helvetica, sans-serif; color:#777777; font-weight:300; text-align:center; ">
                                                        ...
                                                        <?php echo Yii::t('UserModule.views_mails_UserInviteSelf', 'Please click on the button below to join the community and see what you can find on %appName%.', array('%appName%' => Html::encode(Yii::$app->name))); ?>
                                            ...
                                            <table border="0" align="center" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td width="auto" align="center" valign="middle" height="32"
                                                        style=" background-color: #2c305d;  border-radius:5px; background-clip: padding-box;font-size:14px; font-family:Open Sans, Arial,Tahoma, Helvetica, sans-serif; text-align:center;  color:#ffffff; font-weight: 600; padding-left:30px; padding-right:30px; padding-top: 5px; padding-bottom: 5px;">
